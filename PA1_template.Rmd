...
plot2 <- ggplot(adjusted, aes(interval, average))+geom_line()+xlab("number of steps")+theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank())

plot2 + facet_wrap(~day, ncol = 1)
```